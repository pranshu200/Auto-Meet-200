...
public class RoomSuggested {
	...
	public RoomSuggested(List<String> amenities, List<Integer> schedule, List<Integer> organizedById,
			List<String> organizedByName) {
	...
	public String toString() {
		...
		return roomName + " " + credits + " " + ratings + " " + seatingCapacity + " " + amenities + " " + schedule + " "
				+ organizedById + " " + organizedByName;
	}
