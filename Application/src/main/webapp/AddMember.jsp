...
<div  style=" height: 700px;width: 500px;">
    ...
    <label for="list"><b>Member List </b>
    <input type="file" placeholer="memeberList.json" id="list" name="list"><br><br>
  	<button type="submit"  onclick="addMember()" class="registerbtn">Add Member</button>
  </div>
</form>
</div>
</center>
