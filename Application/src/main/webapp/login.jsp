...
<!-- Navbar -->
    <div class="w3-top">
        <div class="w3-bar w3-theme-d2 w3-left-align ">
            ...
            <a href="signUp.jsp" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Sign Up</a>
...
<form action="loginServlet.do" method="post">
  <div class="container">
    ...
    <input type="text" placeholder="Enter User Name" name="userName" id="userName" required></label>

    <label for="email"><b>Email </b>
    <input type="text" placeholder="Enter Email" name="email" id="email" required></label>
